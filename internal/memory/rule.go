...
func RuleContent(contexts []string) string {
	...
	lines = append(lines,
		...
		"| Reading a memory `index.md` directly | Call "+memSearchRef+" or `"+memList+"` | There is no memory directory in the project to read; the wiki is global, compiled and ranked |",
		...
		"So `"+brand.DotDir()+"/memory` does not exist, and neither does a file you could open: both",
