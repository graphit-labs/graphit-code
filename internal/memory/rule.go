...
func RuleContent(contexts []string) string {
	...
	lines = append(lines,
		...
		"|---|---|---|",
		"| Search memories by keyword/context | "+memSearchRef+" | FTS5 over the compiled wiki, ranked and cheap — but every hit is a ~200-char preview, never the full memory |",
