...
// A multi-delivery example is loaded only when the request needs that hierarchy.
const taskWorkedSystem = `# Worked system: a project portal with browsing and downloadable reports
