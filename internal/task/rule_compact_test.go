...
func TestTaskSkillContentContract(t *testing.T) {
	...
	for _, want := range []string{"starting, resuming, planning", "graphit_task_search", "graphit_task_create", "graphit_task_claim", "graphit_task_progress", "graphit_task_complete"} {
