...
func HubRuleContent() string {
	...
	hubContentRef := brand.MCPToolRef("hub", "content")
	hubContent := brand.MCPToolName("hub", "content")
	...
	lines := []string{
		...
		"```",
		hubInstall + "(id: \"<artifact-id>@<version>\")",
		"```",
		"",
		...
		"```",
		astQuery + "(context: \"<artifact-id>@<version>\", query: \"MATCH (f:Function) RETURN f.name, f.path\")",
		brand.MCPToolName("knowledge", "search") + "(context: \"<artifact-id>@<version>\", query: \"<question>\")",
		hubContent + "(id: \"<artifact-id>@<version>\")",
		"```",
		"",
		...
		"inside a project's IDE directory — so " + hubContentRef + " serves their files directly:",
		"```",
		hubContent + "(id: \"<artifact-id>@<version>\")",
		hubContent + "(id: \"<artifact-id>\", type: \"skill\", path: \"SKILL.md\")",
		hubContent + "(project_dir: \"/path/to/project\", id: \"<artifact-id>\")",
		"```",
		"",
		...
		"by name, pointing at " + astSourceRef + " and " + wikiSourceRef + " — those are mounted",
