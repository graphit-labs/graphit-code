...
// SkillReferences returns conditional authoring guidance; retrieval-only sessions
// do not pay the context cost of these resources.
func SkillReferences() map[string]string {
	return map[string]string{
		"references/documentation-design.md": knowledgeDocumentationDesign,
		"references/worked-domain.md":        knowledgeWorkedDomain,
	}
}

const knowledgeDocumentationDesign = `# Designing and maintaining domain documentation
...
const knowledgeWorkedDomain = `# Worked domain: project lifecycle
