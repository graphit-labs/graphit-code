...
// Revision metadata stored in a knowledge index remains visible in reconstructed page source.
func TestReadPageCarriesARevisionChainStoredInTheIndex(t *testing.T) {
	t.Parallel()
	dir := t.TempDir()
	archived := WikiChunk{
