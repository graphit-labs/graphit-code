...
// SetAgentSession binds the persisted chat to the native session of the CLI
// that produced it. ResumeConversation rejects the ID after a CLI change.
func (s *ChatSession) SetAgentSession(sessionID, agentCLI string) error {
