...
func TestNodeColumnsStringCountsIncludeMissingValues(t *testing.T) {
	table := nodeColumnsFrom([]map[string]any{
		{"uid": "a", "lang": "go"},
		{"uid": "b", "lang": "go"},
		{"uid": "c", "lang": "tsx"},
		{"uid": "d"},
	})
	got := table.stringCounts("lang")
	want := map[string]int64{"go": 2, "tsx": 1, "": 1}
	if !reflect.DeepEqual(got, want) {
		t.Fatalf("lang counts = %#v, want %#v", got, want)
	}
}
