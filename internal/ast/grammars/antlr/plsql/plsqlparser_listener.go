...
type PlSqlParserListener interface {
	...
	// EnterKeyword_as_method is called when entering the keyword_as_method production.
	EnterKeyword_as_method(c *Keyword_as_methodContext)
	...
	// ExitKeyword_as_method is called when exiting the keyword_as_method production.
	ExitKeyword_as_method(c *Keyword_as_methodContext)
