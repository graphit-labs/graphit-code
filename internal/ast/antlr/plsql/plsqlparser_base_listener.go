...
// EnterKeyword_as_method is called when production keyword_as_method is entered.
func (s *BasePlSqlParserListener) EnterKeyword_as_method(ctx *Keyword_as_methodContext) {}

// ExitKeyword_as_method is called when production keyword_as_method is exited.
func (s *BasePlSqlParserListener) ExitKeyword_as_method(ctx *Keyword_as_methodContext) {}
