    ...
    "graphit": {
      ...
      "headers": { "Authorization": "Bearer <key>" }
              ...
              <p className="text-[11px] text-muted-foreground leading-relaxed">
                ...
                The daemon runtime key is regenerated on every restart. A local provider may also
                use a static MCP key. With an OIDC broker provider, each caller sends its own access
                token and Graphit preserves that request identity through broker calls.
              </p>
