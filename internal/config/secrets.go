...
// SecretConfigKeys is the canonical list of configuration keys whose value is a credential or
// confidential salt.
//
// It exists so the two things a secret needs are derived from ONE list instead of being
...
//
// Account, MCP, S3, OIDC and STS credentials are deliberately absent because they live in
