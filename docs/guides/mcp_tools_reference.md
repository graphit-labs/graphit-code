...
Read-only status inspection for the global background daemon process.
...
This is the complete daemon contract exposed through MCP. Use the `graphit daemon` CLI commands for
