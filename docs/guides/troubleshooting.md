...
**Currently supported languages (22):** Go, Python, JavaScript, TypeScript, TSX, Java, Rust, C, C++, C#, Kotlin, Swift, Dart, PHP, Ruby, SQL, XML (via Tree-sitter), and PL/SQL, PostgreSQL, T-SQL, DB2, COBOL 85 (via ANTLR v4).
